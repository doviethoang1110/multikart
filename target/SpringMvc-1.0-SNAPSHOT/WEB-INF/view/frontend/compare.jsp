                    ...
                    <div class="table-wrapper table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="item-row"><img src="../assets/images/pro3/1.jpg" alt="" class="featured-image">
                                ...
                                <td class="item-row"><img src="../assets/images/pro3/33.jpg" alt="" class="featured-image">
                                    <div class="product-price product_price"><strong>On Sale:
                                    </strong><span>$89,00</span></div>
                                    <form class="variants clearfix">
                                        <input type="hidden">
                                ...
                                <td class="item-row"><img src="../assets/images/pro3/35.jpg" alt="" class="featured-image">
